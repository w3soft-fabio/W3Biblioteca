...
class RemissivaVerNomePessoalAutoridadePanel extends StatefulWidget {
  final TextEditingController etiqueta_400,
      primeiroIndicador,
      segundoIndicador,
      $a_nomePessoal,
      $b_numeracao,
      ...
      $t_tituloDaObra,
      $v_subdivisaoDeForma,
      $w_subcampoDeControle,
      $x_subdivisaoGeral,
      $y_subdivisaoCronologica,
      $z_subdivisaoGeografica,
      $4_relaciomaneto,
      $5_institutoAQualOCampoSeAplica,
      $6_ligacao,
      $8_campoDeLigacaoENumeroDeSequencia;

  const RemissivaVerNomePessoalAutoridadePanel({
    super.key,
    ...
    required this.$i_informacaoDeRelacionamento,
    ...
    required this.$w_subcampoDeControle,
    required this.$x_subdivisaoGeral,
    required this.$y_subdivisaoCronologica,
    required this.$z_subdivisaoGeografica,
    required this.$4_relaciomaneto,
    required this.$5_institutoAQualOCampoSeAplica,
    required this.$6_ligacao,
    required this.$8_campoDeLigacaoENumeroDeSequencia,
  });

  @override
  State<RemissivaVerNomePessoalAutoridadePanel> createState() =>
      _RemissivaVerNomePessoalAutoridadePanelState();
}

class _RemissivaVerNomePessoalAutoridadePanelState
    extends State<RemissivaVerNomePessoalAutoridadePanel> {
  bool value = false;
        ...
        ExpansionPanel(
          ...
          body: Padding(
            ...
            child: Column(
              ...
              children: [
                TextFormFieldWidget(
                  controller: widget.etiqueta_400,
                  titulo: 'Código',
                  enabled: false,
                  inputFormatters: [
                ...
                const SizedBox(height: 16.0),
                CustomTextFormFieldWidget(
                  controller: widget.$i_informacaoDeRelacionamento,
                  titulo: '\$i - Informação de relacionamento',
                ),
                const SizedBox(height: 16.0),
                CustomTextFormFieldWidget(
                ...
                const SizedBox(height: 16.0),
                CustomTextFormFieldWidget(
                  controller: widget.$w_subcampoDeControle,
                  titulo: '\$w - Subcampo de controle',
                ),
                const SizedBox(height: 16.0),
                CustomTextFormFieldWidget(
                ...
                const SizedBox(height: 16.0),
                CustomTextFormFieldWidget(
                  controller: widget.$4_relaciomaneto,
                  titulo: '\$4 - Relacionamento',
                ),
                const SizedBox(height: 16.0),
                CustomTextFormFieldWidget(
                  controller: widget.$5_institutoAQualOCampoSeAplica,
                  titulo: '\$5 - Instituição à qual o campo se aplica',
                ),
                const SizedBox(height: 16.0),
                CustomTextFormFieldWidget(
