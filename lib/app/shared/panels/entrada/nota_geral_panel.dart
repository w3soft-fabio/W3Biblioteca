...
class NotaGeralPanel extends StatefulWidget {
  ...
  @override
  State<NotaGeralPanel> createState() => _NotaGeralPanelState();
}

class _NotaGeralPanelState extends State<NotaGeralPanel> {
  bool value = false;
  @override
