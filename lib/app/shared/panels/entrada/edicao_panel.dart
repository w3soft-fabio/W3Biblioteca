...
class EdicaoPanel extends StatefulWidget {
  final TextEditingController etiqueta,
      primeiroIndicador,
      segundoIndicador,
      $a_edicao,
      $b_outrasInformacoesSobreEdicao,
  ...
  const EdicaoPanel({
    ...
    required this.$a_edicao,
    required this.$b_outrasInformacoesSobreEdicao,
  ...
  @override
  State<EdicaoPanel> createState() => _EdicaoPanelState();
}

class _EdicaoPanelState extends State<EdicaoPanel> {
  bool value = false;
  @override
          ...
          body: Padding(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 16.0),
                CustomTextFormFieldWidget(
                  controller: widget.$a_edicao,
                  titulo: '\$a - Edição',
                ),
                const SizedBox(height: 16.0),
                CustomTextFormFieldWidget(
                  controller: widget.$b_outrasInformacoesSobreEdicao,
                  titulo: '\$b - Outras informações sobre edição',
                ),
                const SizedBox(height: 16.0),
                CustomTextFormFieldWidget(
