...
class ReservasPage extends StatelessWidget {
  ...
  final int index;
  const ReservasPage({super.key, required this.buscasController, required this.index, required this.reservasController, required this.emailController});
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormFieldWidget(
                  titulo: 'Data reserva',
                  enabled: false,
                  controller: reservasController.reservaDataController = TextEditingController()..text = DateFormat('dd/MM/yyy').format(DateTime.now()),
                  width: 300,
                   inputFormatters: [
                    reservasController.maskCelular,
                    LengthLimitingTextInputFormatter(15),
