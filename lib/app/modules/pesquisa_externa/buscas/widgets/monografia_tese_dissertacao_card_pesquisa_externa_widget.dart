...
class MonografiaTeseDissertacaoCardPesquisaExternaWidget extends StatelessWidget {
  final String nomePessoal, tituloPrincipal, lugarDePublicacao, notaGeral, notaDeDissertacaoOuTese, nomePessoalSecundario, uri;
  final Widget tabCodigoMarcMonografiaTeseDissertacao;
  final void Function()? onPressedAbrirLink;

  const MonografiaTeseDissertacaoCardPesquisaExternaWidget({
    super.key,
                        ...
                        return Dialog(
                          child: SizedBox(
                            ...
                            child: Scaffold(
                              ...
                              body: tabCodigoMarcMonografiaTeseDissertacao,
                            ),
                          ),
                        );
                      },
